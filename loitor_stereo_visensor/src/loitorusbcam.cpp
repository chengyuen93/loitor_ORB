...
// ------------------------------------------------------------------------------------------------------------- uncomment the following lines to print out ----- chengyuen5/9
...
// ------------------------------------------------------------------------------------------------------------- uncomment the following lines to print out ----- chengyuen5/9
    ...
    // {
    //     t<<"mode : "<<(i+1)<<endl;
    //     t<<"fps : "<<modes_settings[i][3]<<endl;
    //     t<<"HB : "<<modes_settings[i][1]<<endl;
    //     t<<"visensor_cam_selection : "<<modes_settings[i][0]<<endl;
    //     t<<"res : "<<modes_settings[i][2]<<endl<<endl;
    // }
    // t.close();

    cout<<endl<<"data_mode : "<<data_mode<<endl;
    cout<<"fps : "<<modes_settings[data_mode-1][3]<<endl;
    cout<<"HB : "<<modes_settings[data_mode-1][1]<<endl;
    cout<<"visensor_cam_selection : "<<modes_settings[data_mode-1][0]<<endl;
    cout<<"res : "<<modes_settings[data_mode-1][2]<<endl<<endl;
...
void visensor_save_current_settings()
{
    ...
    f<<VI_FIFO_matcher<<endl<<"#"<<endl<<"IMU-acc-bias"<<endl;
...
void visensor_Close_IMU()
{
    ...
    if(imu_thread !=0)
    {
        cout << "Joining IMU data feed thread" << endl;
        pthread_join(imu_thread,NULL);
        cout << "IMU data feed thread joined" << endl;
    }
}
...
void *imu_data_feed(void*)
{
    ...
    // cout << "IMU_CLOSE: " << imu_close << endl;
    while(!imu_close)
    {
        // cout << "imu is not closed" << endl;
        if(visensor_get_imu_frame(imu_fd,imu_frame)==0)
        {
            // cout << "IMU got frame" << endl;
